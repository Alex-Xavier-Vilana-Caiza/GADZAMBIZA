...
<div class="red">
    <div id="facebook">
        <a href="https://www.facebook.com/people/GOBIERNO-PARROQUIAL-DE-Z%C3%81MBIZA/100064519253506/" target="none" class="fab fa-facebook-f "></a>
    </div>
    <div id="instagram">
...
<div class="banner">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="hero-text">
                        <h4>GOBIERNO <span>PARROQUIAL ZÁMBIZA</span></h4>
						<br>
						<br>
...
<div class="conatiner">
    <div class="form">
        <div class="contact-info">
                ...
                <p class="contact_text">El Centro de la Parroquia de Zambiza para una
                    mejor atención a la comunidad que la conforma como a los
                    que nos visitan ofreciendo siempre la mejor hospitalidad y
                    bienvenida acojedora a nuestros turistas.
                </p>

            <div class="contactos_info">
                <div class="contact_information">
                    <i class="fas fa-2x fa-map-marker-alt"></i>
                    <p>Calle Guayaquil OE3-101 y Bolívar, 2do Piso</p>
                </div>
                <div class="contact_information">
            ...
            <div class="social_media">
                ...
                <div class="social-icons">
                    <a href="https://www.facebook.com/people/GOBIERNO-PARROQUIAL-DE-Z%C3%81MBIZA/100064519253506/" target="none">
        ...
        <div class="contact-form">
            <form action="" autocomplete="off">
                ...
                <div class="input-container">
                    <input type="tel" name="asunto" class="contact_input" placeholder="ASUNTO">
                </div>
                <div class="input-container">
            ...
            <h2>Social</h2>
                <ul class="box">
                    <li class="button_social">
                        ...
                        <a href="https://www.facebook.com/people/GOBIERNO-PARROQUIAL-DE-Z%C3%81MBIZA/100064519253506/" target="_blank">Facebook</a>
                    </li>
                    <li class="button_social">
